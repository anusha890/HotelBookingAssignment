package com.anusha.hotelbookingassignment;
...
public class MainActivity extends AppCompatActivity  implements DatePickerDialog.OnDateSetListener {
    ...
    private TextView checkout,checkin,country,cost,tvat,tvsc,tnettotal,roomcost,roomno,totaldays;
    private EditText room,child,adult,name;
    private Button btncalculate;
    int y1,y2,m1,m2,d1,d2,diff;
    private Spinner spin, spin1;
    private AutoCompleteTextView autocompletetextview;
    private String[] language={"Deluxe","Platinum","Presidential"};
    @Override
